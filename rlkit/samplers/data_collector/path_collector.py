...
from rlkit.samplers.rollout_functions import active_rollout, rollout


class ActiveMdpPathCollector(PathCollector):
    def __init__(
            self,
            env,
            policy,
        ...
        self._cost = cost
        self._decider_threshhold = decider_threshhold
