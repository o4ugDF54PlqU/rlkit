...
The SE_variance_decider branch contains an experimental change, using the variance between the ensemble of MLPs to decide to measure instead of it being an aditional action for the agent. We have found this change to be too unstable and decided not to move forward with it.
