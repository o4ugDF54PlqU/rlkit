...
This branch contains an experimental change, using the variance between the ensemble of MLPs to decide to measure instead of it being an aditional action for the agent. We have found this change to be more stable than the mean method.
